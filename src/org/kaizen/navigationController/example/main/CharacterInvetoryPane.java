 ...
 */
public class CharacterInvetoryPane extends JPanel {
    ...
    public CharacterInvetoryPane(User user, Observer observer) {
        setLayout(new BorderLayout());
        JLabel mainTitleLabel = new JLabel("Inventory");
